...
§9 = 2026-09-15 目安（当初 2026-09-16 想定 → フェーズ 1 の 72h 化で 2026-09-03〜09-04 へ前倒し → 2026-08-30 の作業窓再設定（8/27〜9/14）で 9/15 に確定 = 計画 §10-5））」に置き換わった。「夜間に destroy しない」という判断自体は不変（むしろ常時稼働の
