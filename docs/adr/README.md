...
| [0015](./0015-ephemeral-layer-acr-container-apps-design.md) | Proposed | ephemeral 層（ACR + Container Apps）の設計 — 最小 SKU・スケールゼロ・egress 経路・イメージタグ方針（ACR pull 認証方式のみ未確定） |
