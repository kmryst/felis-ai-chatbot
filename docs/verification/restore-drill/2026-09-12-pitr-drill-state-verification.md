...
3 行は当時の id `S1` / `S2` / `S3` のまま（証跡上の呼称は `sentinel-2026-09-04T13:36:31Z` / `sentinel-2026-09-04T14:04:30Z` / `sentinel-2026-09-05T07:28:52Z`。[pitr-drill.md](./pitr-drill.md) の用語節）。作り直していない。
